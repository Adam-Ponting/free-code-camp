      ...
      <div id="details-form">
        ...
        >
              ...
              <div class="a" :class="classObject">
                ...
                >
                  ...
                  <label for="silverHeadset"
                    >Headset checked for free movement and adjusted as
                    necessary</label
                  >
                  <br />
                  <input
                  ...
                  <label for="silverHubs"
                    >Wheel Bearings checked for free movement and
                    adjusted</label
                  >
                </div>
                <!-- end silver options -->
                ...
                <div v-if="service.serviceType.level === 'gold'" class="gold">
                  ...
                  <label for="goldThreads"
                    >Frame threads checked for damage and tapped if
                    necessary</label
                  >
                  <br />
                  <input
                  ...
                  <label for="goldBottomBracket"
                    >Bottom Bracket removed, cleaned and regreased as
                    necessary</label
                  >
                  <br />
                  <input
                  ...
                  />
                  <label for="goldHubs"
                    >Wheel hubs disassembled, cleaned, inspected and
                    reassembled</label
                  >
                </div>
                <!-- end gold options -->
          ...
          <fieldset class="confirm">
            <legend class="legend">Confirm &amp; Submit:</legend>
            <!-- start confirm  -->
            <h3 class="confirm__header">Personal Details:</h3>
            <ul>
              <li>
                Name:
            ...
            <h3 class="confirm__header">Bike Details:</h3>
            <ul>
              <li>
                Bike Make &amp; Model:
            ...
            <h3 class="confirm__header">Service Details:</h3>
            <p>
              Service Type:
